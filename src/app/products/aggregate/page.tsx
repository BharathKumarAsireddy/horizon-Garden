...
export const metadata: Metadata = {
  ...
  description:
    "Rocks, decorative stone, and boulders — every aggregate type we carry at our Loxahatchee Groves yard.",
};
...
export default function AggregatePage() {
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <PageBanner
        eyebrow="Aggregate"
        title="Rocks, Stone & Boulders"
        description="Decorative rock, pathway stone, and landscape boulders for pathways, drainage, and hardscape projects of every scale."
      />
      ...
      <section className="bg-[#eef1e7] px-6 py-20">
        <div className="mx-auto max-w-[1200px]">
          <Reveal className="mx-auto mb-10 max-w-[720px]">
            ...
            <p className="mt-3 text-[1rem] leading-relaxed text-[#4b5b47]">
              Polished and tumbled pebbles for planters, accents, and
              finished garden beds.
            </p>
          </Reveal>
          <div className="grid grid-cols-2 gap-3.5 sm:grid-cols-3 md:grid-cols-4">
            {decorativeStoneTypes.map((t, i) => (
              <Reveal key={t.name} delay={(i % 4) * 80}>
                <TypeCard type={t} />
              </Reveal>
            ))}
